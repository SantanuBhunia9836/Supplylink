...
const SellerDashboard = () => {
  ...
  const DesktopTabButton = ({ tabName, icon: Icon, label, onClick }) => {
    const isLocked =
      !isProfileComplete && !["homepage", "profile"].includes(tabName);
    const isActive = activeTab === tabName;
    return (
      <button
        onClick={onClick ? onClick : () => !isLocked && setActiveTab(tabName)}
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-grow flex flex-col md:flex-row md:gap-6 md:p-4 overflow-hidden">
        ...
        <div className="hidden md:flex w-64 flex-shrink-0">
          <div className="bg-white p-4 rounded-xl shadow-md flex flex-col w-full">
            <div className="text-2xl font-bold text-gray-800 p-3 mb-2">
              Dashboard
            </div>
        ...
        <div className="flex-grow md:bg-white md:p-6 md:rounded-xl md:shadow-md overflow-y-auto">
