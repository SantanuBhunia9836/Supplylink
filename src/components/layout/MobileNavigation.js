...
const AccountMenu = ({
  ...
  return (
    ...
    >
      <div
        className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl p-4 pb-8 shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex justify-between items-center mb-4">
          <div className="text-left">
            <p className="font-bold text-lg text-gray-800">{profileName}</p>
        ...
        <div className="space-y-2">
          ...
          <button
            onClick={onLogout}
            className="w-full flex items-center space-x-3 text-lg p-3 text-red-600 hover:bg-red-50 rounded-lg"
          >
