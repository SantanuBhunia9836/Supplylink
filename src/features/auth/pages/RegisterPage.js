...
const checkPasswordStrength = (password) => {
  ...
  if (score <= 2)
    return { strength: "weak", color: "text-red-500", bgColor: "bg-red-50" };
  if (score <= 3)
    return {
      strength: "fair",
  ...
  if (score <= 4)
    return { strength: "good", color: "text-blue-500", bgColor: "bg-blue-50" };
  return {
    strength: "strong",
...
const Input = ({
  ...
  const passwordStrength =
    showPasswordStrength && value ? checkPasswordStrength(value) : null;
