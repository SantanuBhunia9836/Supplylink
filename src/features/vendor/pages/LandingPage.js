...
import SellerListing from "../components/SellerListing"; // Corrected path
// ... existing code ...
    ...
    <>
      <header className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50">
        <div className="container mx-auto px-6 py-24 md:py-32 text-center">
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600">
