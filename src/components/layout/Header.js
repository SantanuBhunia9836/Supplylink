...
const SearchIcon = (props) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>;
...
const Header = ({ pageTitle }) => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6">
      ...
      <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 hidden md:block">{pageTitle}</h1>
      ...
      <div className="flex items-center space-x-4 sm:space-x-6">
        ...
        {user ? (
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            <button onClick={() => navigate('/register')} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Sign Up</button>
          </div>
        )}
      </div>
